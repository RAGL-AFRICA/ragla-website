...
const MembershipBenefits = () => {
  return (
    <div className="min-h-screen bg-background">
      <Helmet>
        <title>Membership Benefits & Categories | Join RAGLA's Network of Excellence</title>
        <meta name="description" content="Explore RAGLA's membership categories from Affiliate to Fellow. Discover the professional benefits, networking, and capacity-building opportunities." />
        <link rel="canonical" href="https://ragl-africa.org/membership-benefits" />
      </Helmet>
      <Header />
