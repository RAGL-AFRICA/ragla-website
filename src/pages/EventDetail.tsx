...
import EventExecutiveSummary from "@/components/EventExecutiveSummary";
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="pb-20">
        <div className="container-main pt-8">
           <Button variant="ghost" asChild className="-ml-3 text-muted-foreground hover:text-primary transition-colors text-xs font-bold uppercase tracking-widest mb-6">
              <Link to="/events">
        ...
        {/* Standard Event Header Section - Only show if NO registration form */}
        {!hasForm && (
        ...
        <div className="container-main">
          {/* Use the new Executive Summary Template */}
          {hasForm ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[1fr,380px] gap-12">
              ...
              {/* Sidebar - Only fallback if no form */}
