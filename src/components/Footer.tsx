        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-12 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-2 lg:col-start-6">
            ...
            <ul className="space-y-4">
              ...
              <li><a href="https://student.ragl-africa.org/membership/login" target="_blank" rel="noopener noreferrer" className="text-muted-foreground text-sm font-medium hover:text-primary transition-colors flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-yellow-500" /> Membership Portal</a></li>
              <li><a href="https://student.ragl-africa.org/library" target="_blank" rel="noopener noreferrer" className="text-muted-foreground text-sm font-medium hover:text-primary transition-colors flex items-center gap-2"><div className="w-1.5 h-1.5 rounded-full bg-blue-500" /> Resource Centre</a></li>
            </ul>
          </div>
