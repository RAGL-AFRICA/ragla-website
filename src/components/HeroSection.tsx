...
const HeroSection = () => {
  return (
    <section className="relative min-h-[60vh] sm:min-h-[70vh] md:min-h-[80vh] flex items-center overflow-hidden">
      ...
      <div className="container-main relative z-10 grid md:grid-cols-2 gap-6 md:gap-12 items-center py-10 sm:py-14 md:py-24">
        {/* Left: headline */}
        <motion.div
        ...
        >
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[4rem] font-black text-foreground leading-[1.15] tracking-tight">
        ...
        <motion.div
          ...
          className="flex flex-col gap-6 md:gap-8 md:pl-10 lg:pl-16 border-l-0 md:border-l border-border/50"
        >
          ...
          <div className="flex flex-col xs:flex-row sm:flex-row gap-3 sm:gap-4">
            <Link
              to="/apply"
              className="bg-primary text-primary-foreground text-center py-3 sm:py-4 px-6 sm:px-8 rounded-xl font-bold shadow-lg shadow-primary/20 hover:-translate-y-1 hover:shadow-primary/40 transition-all duration-300 uppercase tracking-wider text-xs sm:text-sm flex-1"
            >
              Apply for Membership
            </Link>
            <Link
              to="/about-us"
              className="bg-secondary text-foreground border border-border text-center py-3 sm:py-4 px-6 sm:px-8 rounded-xl font-bold hover:bg-secondary/80 hover:-translate-y-1 transition-all duration-300 uppercase tracking-wider text-xs sm:text-sm flex-1"
            >
              Discover RAGLA
            </Link>
          </div>
